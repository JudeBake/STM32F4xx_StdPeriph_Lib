/**
 * \file AsyncSerialPort5.h
 * \class AsyncSerialPort5
 * \brief Singleton of the asynchronous port 5.
 *
 * This class is the second level driver of the serial port 5 in asynchronous
...
#ifndef ASYNCSERIALPORT5_H_
#define ASYNCSERIALPORT5_H_
...
/**
 * \def SERIAL_PORT5_BUFFERS_LENGTH
 * \brief The length of the Rx/Tx buffers of the port.
 */
#define SERIAL_PORT5_BUFFERS_LENGTH		100

/**
 * \def SERIAL_PORT5_PREEMP_PRIORITY
 * \brief The preemptive priority of the port.
 */
#define SERIAL_PORT5_PREEMP_PRIORITY	15

/**
 * \def SERIAL_PORT5_SUBPRIORITY
 * \brief The sub-priority of the port.
 */
#define SERIAL_PORT5_SUBPRIORITY		0

class AsyncSerialPort5
{
public:
	/* Port handle */
	static AsyncSerialPort5* portHandle; /**<Handle of the port. */
...
private:
	...
	/* Constructors */
	AsyncSerialPort5(void);
	AsyncSerialPort5(const AsyncSerialPort5&);
	void operator=(const AsyncSerialPort5&);
...
public:
	 ...
	 */
	static AsyncSerialPort5* getInstance(void);
	...
	SerialStatus portInit(Parity iParityConf, StopBits iStopBitConf,
			DataBits iDataLengthConf, LinkMode iLinkMode,
