/**
 * \file AsyncSerialPort6.h
 * \class AsyncSerialPort6
 * \brief Singleton of the asynchronous port 6.
 *
 * This class is the second level driver of the serial port 6 in asynchronous
...
#ifndef ASYNCSERIALPORT6_H_
#define ASYNCSERIALPORT6_H_
...
/**
 * \def SERIAL_PORT6_BUFFERS_LENGTH
 * \brief The length of the Rx/Tx buffers of the port.
 */
#define SERIAL_PORT6_BUFFERS_LENGTH		100

/**
 * \def SERIAL_PORT6_PREEMP_PRIORITY
 * \brief The preemptive priority of the port.
 */
#define SERIAL_PORT6_PREEMP_PRIORITY	15

/**
 * \def SERIAL_PORT6_SUBPRIORITY
 * \brief The sub-priority of the port.
 */
#define SERIAL_PORT6_SUBPRIORITY		0

class AsyncSerialPort6
{
public:
	/* Port handle */
	static AsyncSerialPort6* portHandle; /**<Handle of the port. */
...
private:
	...
	/* Constructors */
	AsyncSerialPort6(void);
	AsyncSerialPort6(const AsyncSerialPort6&);
	void operator=(const AsyncSerialPort6&);
...
public:
	 ...
	 */
	static AsyncSerialPort6* getInstance(void);
