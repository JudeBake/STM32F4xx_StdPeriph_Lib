/**
 * \file AsyncSerialPort4.h
 * \class AsyncSerialPort4
 * \brief Singleton of the asynchronous port 4.
 *
 * This class is the second level driver of the serial port 4 in asynchronous
...
#ifndef ASYNCSERIALPORT4_H_
#define ASYNCSERIALPORT4_H_
...
/**
 * \def SERIAL_PORT4_BUFFERS_LENGTH
 * \brief The length of the Rx/Tx buffers of the port.
 */
#define SERIAL_PORT4_BUFFERS_LENGTH		100

/**
 * \def SERIAL_PORT4_PREEMP_PRIORITY
 * \brief The preemptive priority of the port.
 */
#define SERIAL_PORT4_PREEMP_PRIORITY	15

/**
 * \def SERIAL_PORT4_SUBPRIORITY
 * \brief The sub-priority of the port.
 */
#define SERIAL_PORT4_SUBPRIORITY		0

class AsyncSerialPort4
{
public:
	/* Port handle */
	static AsyncSerialPort4* portHandle; /**<Handle of the port. */
...
private:
	...
	/* Constructors */
	AsyncSerialPort4(void);
	AsyncSerialPort4(const AsyncSerialPort4&);
	void operator=(const AsyncSerialPort4&);
...
public:
	 ...
	 */
	static AsyncSerialPort4* getInstance(void);
