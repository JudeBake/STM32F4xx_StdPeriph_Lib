/**
 * \file AsyncSerialPort2.h
 * \class AsyncSerialPort2
 * \brief Singleton of the asynchronous port 2.
 *
 * This class is the second level driver of the serial port 2 in asynchronous
...
#ifndef ASYNCSERIALPORT2_H_
#define ASYNCSERIALPORT2_H_
...
/**
 * \def SERIAL_PORT2_BUFFERS_LENGTH
 * \brief The length of the Rx/Tx buffers of the port.
 */
#define SERIAL_PORT2_BUFFERS_LENGTH		100

/**
 * \def SERIAL_PORT2_PREEMP_PRIORITY
 * \brief The preemptive priority of the port.
 */
#define SERIAL_PORT2_PREEMP_PRIORITY	15

/**
 * \def SERIAL_PORT2_SUBPRIORITY
 * \brief The sub-priority of the port.
 */
#define SERIAL_PORT2_SUBPRIORITY		0

class AsyncSerialPort2
{
public:
	/* Port handle */
	static AsyncSerialPort2* portHandle; /**<Handle of the port. */
...
private:
	...
	/* Constructors */
	AsyncSerialPort2(void);
	AsyncSerialPort2(const AsyncSerialPort2&);
	void operator=(const AsyncSerialPort2&);
...
public:
	 ...
	 */
	static AsyncSerialPort2* getInstance(void);
