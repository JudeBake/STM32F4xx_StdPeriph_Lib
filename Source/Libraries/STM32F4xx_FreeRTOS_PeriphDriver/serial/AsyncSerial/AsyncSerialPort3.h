/**
 * \file AsyncSerialPort3.h
 * \class AsyncSerialPort3
 * \brief Singleton of the asynchronous port 3.
 *
 * This class is the second level driver of the serial port 3 in asynchronous
...
#ifndef ASYNCSERIALPORT3_H_
#define ASYNCSERIALPORT3_H_
...
/**
 * \def SERIAL_PORT3_BUFFERS_LENGTH
 * \brief The length of the Rx/Tx buffers of the port.
 */
#define SERIAL_PORT3_BUFFERS_LENGTH		100

/**
 * \def SERIAL_PORT3_PREEMP_PRIORITY
 * \brief The preemptive priority of the port.
 */
#define SERIAL_PORT3_PREEMP_PRIORITY	15

/**
 * \def SERIAL_PORT3_SUBPRIORITY
 * \brief The sub-priority of the port.
 */
#define SERIAL_PORT3_SUBPRIORITY		0

class AsyncSerialPort3
{
public:
	/* Port handle */
	static AsyncSerialPort3* portHandle; /**<Handle of the port. */
...
private:
	...
	/* Constructors */
	AsyncSerialPort3(void);
	AsyncSerialPort3(const AsyncSerialPort3&);
	void operator=(const AsyncSerialPort3&);
...
public:
	 ...
	 */
	static AsyncSerialPort3* getInstance(void);
